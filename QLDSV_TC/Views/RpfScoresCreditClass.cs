...
{
    public partial class RpfScoresCreditClass : XtraForm
    {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            if (checkData())
            {
                ...
                Reports.XrptScoresCreditClass xrpt = new Reports.XrptScoresCreditClass(schoolYear, semester, subjectCode, group);
